...
using ServiceManager.UI.Vutility;
using ServiceManager.UI.View;
using System.IO;

#region TASKS

// TODO: 
// - remove hardcoded testing stuff once finished
// minor TODO:
...
{
    public partial class FloorPlanDrawingControl : BaseDetailControl
    {
        #region Variables
        /*
        ...
        public Dictionary<int, IShape> ShapesDict = new Dictionary<int, IShape>();
        //shapeCount is used as the key of ShapesDict
        private int shapeCount = 0;                
        private bool drawCir, drawLine,textbox_IsDrawn, drawRec, drawText, drawTri, drawDotted, eraser, fill, scaleShape, moving, just_cleared;        
        private SolidBrush brush_color;
        private KeyValuePair<int, IShape> selectedShape;
        public List<ShapeAction> Actions = new List<ShapeAction>();
        public Stack<ShapeAction> redo_stack = new Stack<ShapeAction>();                
        public Stack<IShape> clear_all_stack = new Stack<IShape>();
        private Point previousPoint = Point.Empty;
    

        // TEMP TESTING BOOL -- set to true for testing
        private bool testing = false;
        private RichTextBox redoTb = new RichTextBox();
        private RichTextBox undoTb = new RichTextBox();
        private RichTextBox shapesDictTb = new RichTextBox();

        #endregion

        #region Methods
        /// <summary>
        /// Constructor intializes compenent, sets brush to black and enables Double Buffering
        /// </summary>
        public FloorPlanDrawingControl()
        {
            InitializeComponent();
        ...
        */
        ...
        private void undo_button_Click(object sender, EventArgs e)
        {
            ...
            {
                //lookup last action
                //ShapeAction lastAction = Actions.Last();   // <- VS2008 doesn't allow .Last
                ShapeAction lastAction = Actions[Actions.Count - 1];
        ...
        private void saveToolStripMenuItem_Click(object sender, EventArgs e)
        {
            ...
            using (System.IO.FileStream saveStream = new System.IO.FileStream(@"C:\Documents and Settings\KPannell\Desktop\testing.png", System.IO.FileMode.OpenOrCreate))
            {
                bmp.Save(saveStream, System.Drawing.Imaging.ImageFormat.Png);
            }
        ...
        private void loadToolStripMenuItem_Click(object sender, EventArgs e)
        {
            ...
            mOpenFileDialog.Filter = "JPG Files (*.jpg)|*.jpg|GIF Files (.gif)|*.gif";

            if (mOpenFileDialog.ShowDialog() == DialogResult.OK)
            {
                FileInfo fInfo = new FileInfo(mOpenFileDialog.FileName);

                if (fInfo.Length < 100000)
                {
                    byte[] image = ReadFile(mOpenFileDialog.FileName);
                }
                else
                {
                    MessageBox.Show("File is too large. File must be less than 100KB.", "eData Error", MessageBoxButtons.OK, MessageBoxIcon.Exclamation);
                }
